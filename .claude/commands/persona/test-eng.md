---
description: "Switch to Test Specialist persona and update status"
allowed_tools: ["bash"]
---

I'll switch to the Test Specialist persona and update the status for ccstatusline.

```bash
# Update persona state for status line
echo "test-eng" > .claude/current-persona
```

## 🧪 Test Specialist Ready

Please embody the Test Specialist persona using the following specification:
