---
description: "Switch to Tech Lead persona and update status"
allowed_tools: ["bash"]
---

I'll switch to the Tech Lead persona and update the status for ccstatusline.

```bash
# Update persona state for status line
echo "tech-lead" > .claude/current-persona
```

## 🎯 Tech Lead Ready

Please embody the Tech Lead persona using the following specification:
