...
### Secondary (Read Only)
- **[ReviewGaps.md](../01-Active/ReviewGaps.md)** - Generated by backlog-assistant (read-only)
- **[PrioritizerKnowledge.md](strategic-prioritizer/PrioritizerKnowledge.md)** - My learning database
- **[Ideas.md](../07-Archive/Historical/Ideas.md)** - Future possibilities (legacy location)
- **[Completed_Backlog.md](../07-Archive/Completed_Backlog.md)** - Historical items (monthly cleanup)

### Reference Only
- **[HANDBOOK.md](../03-Reference/HANDBOOK.md)** - Daily technical companion with architecture and patterns
- **Legacy Reference**: [Architecture.md](../99-Deprecated/03-Reference/Architecture.md), [QuickReference.md](../99-Deprecated/03-Reference/QuickReference.md) - Use HANDBOOK.md primarily
