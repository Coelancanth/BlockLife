...
/// <summary>
/// Manages input state including selection, hover position, and input modes.
/// Refactored from BlockSelectionManager to be more general purpose.
/// </summary>
public sealed class InputStateManager : IDisposable
{
    ...
    public void SetMode(InputMode mode)
    {
        ...
        {
            _logger?.Debug("Input mode changed from {OldMode} to {NewMode}", _currentMode, mode);
            _currentMode = mode;
        }
    }
    ...
    {
        // This can be extended to track various modifier keys
